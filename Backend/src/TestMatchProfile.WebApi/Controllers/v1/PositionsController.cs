...
using TestMatchProfile.Application.Features.Positions.Commands.DeletePositionById;
using TestMatchProfile.Application.Features.Positions.Commands.UpdatePosition;
using TestMatchProfile.Application.Features.Positions.Queries.GetPositionById;
...
namespace TestMatchProfile.WebApi.Controllers.v1
{
    ...
    public class PositionsController : BaseApiController
    {
        ...
        [Route("AddMock")]
        //[Authorize]
        public async Task<IActionResult> AddMock(CreatePositionCommand command)
        {
